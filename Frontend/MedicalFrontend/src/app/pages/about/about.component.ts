...
@Component({
  ...
  template: `
    <section class="page-section">
      <div class="container">
        <h1 class="page-title">About Clinic</h1>
        <p class="page-lead">Premium healthcare services with compassion.</p>
        <p>We are committed to providing excellent medical care with a patient-centered approach.</p>
